...
public class Node {
    ...
    public Node insertByFrom(Node aux, Email dat) throws Exception {
        ...
        } else if (aux.dat.getInicio().getDato().getFrom().compareTo(dat.getFrom()) < 0) {
    ...
    public Node insertByDate(Node aux, Email dat) throws Exception {
        ...
        if (aux.dat.getInicio().getDato().getDate().compareTo(dat.getDate()) > 0) {
            aux.left = insertByDate(aux.left, dat);
        } else if (aux.dat.getInicio().getDato().getDate().compareTo(dat.getDate()) < 0) {
            aux.right = insertByDate(aux.right, dat);
        } else {
            this.dat.insertar(dat);
        }
